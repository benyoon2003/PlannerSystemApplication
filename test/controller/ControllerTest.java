...
public class ControllerTest {
  ...
  private void exampleSchedulingControllerLenient() {
    ...
    this.testEvent = this.model.createEvent("Ben", "OOD", "Snell", false,
            Day.Monday, 0, Day.Wednesday, 1000, List.of());
    this.controller = new NUPlannerController(this.model, new LenientStrat(), this.view);
  }
...
//    this.view.render(this.model.findEvent(ben.toString(), 0, Day.Sunday));
//  }
//
//  @Test
...
//    this.view.render(testEvent);
//    this.view.render(this.model.findEvent(ben.toString(), 1100, Day.Wednesday));
...
//    this.view.reMakeView(nico, this.controller.createNewEvent());
...
//  }
  ...
  public void testScheduleEventAnytime() {
    exampleSchedulingControllerAnytime();
    this.controller.scheduleEvent("Ben", "EVENT", true, "Snell",
            new ArrayList<>(), 200);
    String[] output = this.view.displayUserSchedule().split("\n");
    this.view.render(testEvent);
