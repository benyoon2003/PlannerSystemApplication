 ...
 */
class EventPanelIMPL extends JPanel implements MouseListener, EventPanel {
  ...
  EventPanelIMPL(IEvent e, int x, int y, int width, int height, int horiz, String[] availUsers,
