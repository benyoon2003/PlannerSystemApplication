...
/**
 * The EventPanel is a custom JPanel that implements MouseListener. It represents
 ...
 */
abstract class EventPanel extends JPanel implements MouseListener{
  ...
  EventPanel(IEvent e, int x, int y, int width, int height, int horiz, String[] availUsers,
